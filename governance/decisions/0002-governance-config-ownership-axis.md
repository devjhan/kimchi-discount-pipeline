...
- **Extended-by ADR-0015** — 소유 축(본 ADR)에 직교하는 *결합 축*(cross-cutting 정책계약 vs
  single-BC 운영 vs 사용자 결정)을 추가해 "이 config 가 governance/ · domains/<bc>/config/ ·
  config/user/ 중 어디냐" 의 일반 판별 기준을 완성.
