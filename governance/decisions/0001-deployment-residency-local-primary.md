...
`status: Accepted`
`date: 2026-06-06`
`refs: G9, deployment-residency.md`
...
*결정 우선순위* 는 [`deployment-residency.md`](deployment-residency.md) 에
있고, 그 spec 은 스스로 "AGENTS.md / 수많은 hard guard / 모든 deployment 결정의 상위" 라고
선언한다 (헌법성 spec). Hard Guards는 `AGENTS.md` (G1-G22) 과 `governance/policy/hard_guards.yaml` (G13)에 산재. ADR 레지스터는 그 결정을 ledger 에 등록만 한다.
